...
O `wrangler.jsonc` também declara `./out` como `pages_build_output_dir`. Isso evita deployments vazios quando as configurações de saída do painel não estão preenchidas corretamente.
